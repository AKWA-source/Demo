...
import functionalLibraries.ReadExcel;
import functionalLibraries.Screenshot;

public class App {
	public  WebDriver driver;
	public static String path = "./src/functionalLibraries/Data.xlsx";
	...
	public void withoutmain() throws Exception {
		...
		FileInputStream objfile = new FileInputStream("./src/test/Repository.properties");
		obj.load(objfile);
